 ...
 *
 * Structures defining the format of the ITTs and DLBs for microcode with DLBs of small size.
 *
 */

#ifndef SRC_MICROCODE_BASE_FORMAT_H_
#define SRC_MICROCODE_BASE_FORMAT_H_
...
// ITT_IDX | SW_LEN | RF_N | DST_N_SA | SHIFT_SA | SRC0_N | DST | SRC0
...
#define MACRO_SHIFTSA_BITS  (LOG2(SA_MAX_SHIFT+1))
...
#define MACRO_AUX_BITS      (ITT_IDX_BITS + \
                            (MAX((MACRO_IMM_BITS+MACRO_DST_BITS+MACRO_SRC_BITS),\
                             MAX(MACRO_SW_LEN_BITS+MACRO_RF_N_BITS+MACRO_DST_N_SA_BITS+MACRO_SHIFTSA_BITS+MACRO_SRC0_N_BITS+MACRO_DST_BITS+MACRO_SRC_BITS,\
...
#define SA_SHIFT_BITS       MACRO_SHIFTSA_BITS
#define SA_DST_BITS         3
#define SA_SRC0_BITS        2
#define SA_FIELDS_BITS      (SA_SW_LEN_BITS+SA_SHIFT_BITS+SA_DST_BITS+SA_SRC0_BITS)
...
#endif /* SRC_MICROCODE_BASE_FORMAT_H_ */
